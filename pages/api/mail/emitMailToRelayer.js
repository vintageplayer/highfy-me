...
import { relayerDetails } from "../../../lib/relayer";
...
export default async function handler(req, res) {
  if (req.method == "POST") {
    ...
    console.log(contractABI[1].inputs)
    ...
    var rawTransaction = {"from":myAddress, "gasPrice":web3.utils.toHex(20* 1e9),"gasLimit":web3.utils.toHex(210000),"to":contractAddress,"value":web3.utils.toHex(0),"data":contract.methods.forward(_to, _from, _data, _signature).encodeABI(),"nonce":web3.utils.toHex(count)}
    ...
    try {
      ...
      const txRes = {'error': 'EVM reverted'};
    }
